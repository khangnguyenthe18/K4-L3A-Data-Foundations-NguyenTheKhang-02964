...
**Phiên bản bài nộp:** group-hiep-v2; ngày 19/09/2026
...
- `HeadingChunker(800)`: giữ ancestry của tiêu đề trong từng đoạn con, dành tối đa khoảng 1/3 ngân sách cho heading và recursive split phần thân. Đây là strategy được chọn trình bày cá nhân, không tuyên bố thắng mọi metric.
...
Python **3.11.9**. **68/68 tests pass**, trong đó có **42 tests gốc**; còn lại là edge cases, concurrency, ingestion, benchmark alignment, import log và evidence coverage. [JUnit](artifacts/test_results.xml) và [console log](artifacts/test_results.txt).
...
Đã chạy đúng nguyên văn **5 câu Hiệp gửi**, cùng filters và markers: [queries.json](../benchmark/queries.json). Chọn TF-IDF + heading 800, top_k=3. **3/5 Hit@3**, MRR@3 **0.500**. Đây là kết quả group-hiep-v2; không dùng kết quả 5/5 của bộ câu hỏi local-v1.

| Query | Top-1 chunk | Score | Evidence rank | Coverage | Answer chứa markers? |
| --- | --- | --- | --- | --- | --- |
| Q1 | ueh-dao-van-ai-quy-dinh-chung:heading:004 | 0.5090 | 2 | 100% | True |
| Q2 | ueh-xu-ly-vi-pham-nguoi-hoc:heading:002 | 0.4437 | 1 | 100% | True |
| Q3 | ueh-dao-van-ai-quy-dinh-chung:heading:014 | 0.2268 | None | 0% | False |
| Q4 | ueh-dao-van-ai-quy-dinh-chung:heading:017 | 0.2430 | None | 0% | False |
| Q5 | tt49-2026-ung-dung-cong-nghe-ai:heading:024 | 0.4245 | 1 | 100% | True |

### Đánh giá câu trả lời theo rubric (tham khảo)

| Query | Điểm tham khảo /2 | Căn cứ |
| --- | --- | --- |
| Q1 | 1 | Output có ngưỡng và các loại trừ, đồng thời có cảnh báo không kết luận chỉ bằng tỷ lệ; evidence chính ở rank 2 nên tạm tính 1 theo rubric. |
...
| Q5 | 2 | Rank 1 chứa ngày hiệu lực và cả hai số thông tư; output giữ nguyên Điều 22 và citation theo snapshot. Không xác nhận tình trạng pháp lý hiện tại. |

Tổng tham khảo **5/10** cho cấu hình cá nhân, do AI hỗ trợ đối chiếu output với gold/rubric; không phải điểm giảng viên. Q3/Q4 cần cải thiện retrieval. Extractive output dài hơn câu trả lời tự nhiên nhưng cho phép kiểm tra nguồn.
...
| --- | --- | --- | --- |
| 1 | ueh-dao-van-ai-quy-dinh-chung:heading:004 | 0.5090 | False |
| 2 | ueh-dao-van-ai-quy-dinh-chung:heading:005 | 0.4734 | True |
| 3 | ueh-dao-van-ai-quy-dinh-chung:heading:008 | 0.4382 | False |
...
| Rank | Chunk ID | Score | Chứa primary marker? |
| --- | --- | --- | --- |
| 1 | ueh-xu-ly-vi-pham-nguoi-hoc:heading:002 | 0.4437 | True |
| 2 | ueh-xu-ly-vi-pham-nguoi-hoc:heading:005 | 0.3701 | True |
| 3 | ueh-xu-ly-vi-pham-nguoi-hoc:heading:001 | 0.3357 | False |
...
| Rank | Chunk ID | Score | Chứa primary marker? |
| --- | --- | --- | --- |
| 1 | ueh-dao-van-ai-quy-dinh-chung:heading:014 | 0.2268 | False |
| 2 | ueh-dao-van-ai-quy-dinh-chung:heading:017 | 0.1978 | False |
| 3 | tt49-2026-ung-dung-cong-nghe-ai:heading:016 | 0.1549 | False |
...
| Rank | Chunk ID | Score | Chứa primary marker? |
| --- | --- | --- | --- |
| 1 | ueh-dao-van-ai-quy-dinh-chung:heading:017 | 0.2430 | False |
| 2 | ueh-dao-van-ai-quy-dinh-chung:heading:014 | 0.2408 | False |
| 3 | ueh-dao-van-ai-quy-dinh-chung:heading:015 | 0.2369 | False |
...
| Rank | Chunk ID | Score | Chứa primary marker? |
| --- | --- | --- | --- |
| 1 | tt49-2026-ung-dung-cong-nghe-ai:heading:024 | 0.4245 | True |
| 2 | tt49-2026-ung-dung-cong-nghe-ai:heading:000 | 0.3574 | False |
| 3 | tt49-2026-ung-dung-cong-nghe-ai:heading:009 | 0.3476 | False |
