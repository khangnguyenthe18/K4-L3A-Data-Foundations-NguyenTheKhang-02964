...
Bộ group-hiep-v2: cùng 5 câu, filters và evidence markers như log Hiệp.
...
|---|---|---:|---:|---:|---:|---:|
| tfidf | fixed_size | 92 | 762.9 | 60% | 0.600 | 0.267 |
...
| mock | fixed_size | 92 | 762.9 | 0% | 0.000 | 0.000 |
...
1. `ueh-dao-van-ai-quy-dinh-chung:fixed_size:002` — score 0.5535; relevant=True
...
2. `ueh-dao-van-ai-quy-dinh-chung:fixed_size:001` — score 0.4524; relevant=False
...
3. `ueh-dao-van-ai-quy-dinh-chung:fixed_size:005` — score 0.3907; relevant=False
...
1. `ueh-xu-ly-vi-pham-nguoi-hoc:fixed_size:001` — score 0.3985; relevant=True
...
2. `ueh-xu-ly-vi-pham-nguoi-hoc:fixed_size:003` — score 0.3754; relevant=True
...
3. `ueh-xu-ly-vi-pham-nguoi-hoc:fixed_size:000` — score 0.3280; relevant=False
...
> c) Sau bảo vệ:
> 
> Sau khi đã bảo vệ, nếu có phát hiện lỗi đạo văn, tác giả chịu trách
...
1. `ueh-dao-van-ai-quy-dinh-chung:fixed_size:008` — score 0.1944; relevant=False

>  AI tạo sinh đã sử dụng, mục đích sử dụng (tóm tắt, dịch thuật, tạo hình, viết mã v.v.) và những nội dung có sự hỗ trợ của AI tạo sinh trong sản phẩm học thuật. Việc khai báo cần thực hiện theo chuẩn, ví dụ: Trong phần Acknowledgement hoặc Phương pháp nghiên cứu ghi: “Một phần nội dung của sản phẩm này được hỗ trợ bởi ChatGPT (phiên bản …), sử dụng cho mục đích tóm tắt tài liệu/tham khảo ý tưởng/ngôn ngữ.”
...
> - Không lạm dụng: không

2. `ueh-dao-van-ai-quy-dinh-chung:fixed_size:004` — score 0.1700; relevant=False

> ặc không công khai mà không ghi nguồn hoặc không trích dẫn.
> c) Tự đạo văn
> 
> - Tái sử dụng nội dung đã nộp hoặc đã công bố trước đó mà không trích dẫn hoặc nêu rõ nguồn gốc.
> - Công bố lại sản phẩm khoa học cũ mà không chỉ rõ nguồn gốc và tình trạng công bố.
> d) Lỗi trích dẫn và ghi nguồn (vi phạm quy tắc trích dẫn và liêm chính học thuật)
> 
> - Trích dẫn sai, không đầy đủ hoặc sai định dạng nghiêm trọng.
> - Liệt kê tài liệu tham khảo nhưng không sử dụng trong nội dung bài viết.
> - Ghi sai nguồn, ghi nguồn không tồn tại hoặc không thể kiểm chứng.
> - Sử dụng dữ liệu nghiên cứu của người khác mà không ghi nguồn hoặc không trích dẫn.
> 
> ## Điều 3. Phát hiện và xử lý hành vi đạo văn
> 
> 1. UEH sử dụng phần mềm Turnitin và/hoặc công cụ tương đương để phát hiện tỷ lệ tương đồng học thuật trong các sản phẩm học

3. `ueh-dao-van-ai-quy-dinh-chung:fixed_size:009` — score 0.1614; relevant=False

> hiên cứu nội bộ của UEH hoặc đối tác nếu chưa được phép.
...
> - Tôn trọng quyền riêng tư, sở hữu trí tuệ và bảo mật dữ liệu: không cung cấp cho AI dữ liệu cá nhân, dữ liệu mật, thông tin chưa công bố hoặc dữ liệu nghiên cứu nội bộ của UEH hoặc đối tác nếu chưa được phép.
> - Không lạm dụng: không
> [ueh-dao-van-ai-quy-dinh-chung:fixed_size:008](https://daotao.ueh.edu.vn/quy-dinh-ve-viec-kiem-soat-xu-ly-hanh-vi-dao-van-su-dung-tri-tue-nhan-tao-ai-trong-cac-san-pham-hoc-thuat-tai-dai-hoc-kinh-te-thanh-pho-ho-chi-minh/)
> 
> ặc không công khai mà không ghi nguồn hoặc không trích dẫn.
> c) Tự đạo văn
> 
...
1. `ueh-dao-van-ai-quy-dinh-chung:fixed_size:009` — score 0.2815; relevant=False
...
2. `ueh-dao-van-ai-quy-dinh-chung:fixed_size:008` — score 0.2773; relevant=False
...
3. `ueh-dao-van-ai-quy-dinh-chung:fixed_size:006` — score 0.2332; relevant=False

> ghiêm khắc theo quy định hiện hành của UEH và pháp luật có liên quan.
...
> 
> 1. Trong Quy định này, trí tuệ nhân tạo (AI) được hiểu là các công cụ, hệ thống hoặc thuật toán có khả năng tạo, phân tích hoặc xử lý nội dung hỗ trợ hoạt động học thuật. AI được xem là công cụ hỗ trợ, không thay thế trách nhiệm tư duy, phân tích và sáng tạo của tác giả. AI trong học thuật được phân loại thành hai nhóm chính: (1) AI hỗ trợ (Assistive AI), là các công cụ hoặc tính năng sử dụng AI để hỗ trợ kỹ thuật như chỉnh lỗi ngôn ngữ, kiểm tra chính tả, ngữ pháp, dịch thuật hoặc đề xuất cấu trúc câu, bao gồm nhưng khô
...
> 
> 1. Trong Quy định này, trí tuệ nhân tạo (AI) được hiểu là các công cụ, hệ thống hoặc thuật toán có khả năng tạo, phân tích hoặc xử lý nội dung hỗ trợ hoạt động học thuật. AI được xem là công cụ hỗ trợ, không thay thế trách nhiệm tư duy, phân tích và sáng tạo của tác giả. AI trong học thuật được phân loại thành hai nhóm chính: (1) AI hỗ trợ (Assistive AI), là các công cụ hoặc tính năng sử dụng AI để hỗ trợ kỹ thuật như chỉnh lỗi ngôn ngữ, kiểm tra chính tả, ngữ pháp, dịch thuật hoặc đề xuất cấu trúc câu, bao gồm nhưng khô
> [ueh-dao-van-ai-quy-dinh-chung:fixed_size:006](https://daotao.ueh.edu.vn/quy-dinh-ve-viec-kiem-soat-xu-ly-hanh-vi-dao-van-su-dung-tri-tue-nhan-tao-ai-trong-cac-san-pham-hoc-thuat-tai-dai-hoc-kinh-te-thanh-pho-ho-chi-minh/)
...
1. `tt49-2026-ung-dung-cong-nghe-ai:fixed_size:016` — score 0.3496; relevant=True

> bên tham gia hoạt động học thuật có trách nhiệm tuân thủ quy định về liêm chính học thuật; trung thực trong học tập, giảng dạy, nghiên cứu khoa học và công bố việc sử dụng công nghệ, trí tuệ nhân tạo khi có yêu cầu.
> 
...
2. `tt49-2026-ung-dung-cong-nghe-ai:fixed_size:017` — score 0.2899; relevant=False

> o dục đại học hết hiệu lực thi hành từ ngày Thông tư này có hiệu lực.
> 
...
3. `tt49-2026-ung-dung-cong-nghe-ai:fixed_size:000` — score 0.2859; relevant=False
...
> 
> 1. Cơ sở giáo dục đại học; cơ sở giáo dục khác tại Khoản 2, Đi
...
> 
> 3. Chánh
> [tt49-2026-ung-dung-cong-nghe-ai:fixed_size:016](https://luatvietnam.vn/giao-duc/thong-tu-49-2026-tt-bgddt-ung-dung-cong-nghe-trong-giao-duc-dai-hoc-va-nghe-nghiep-439350-d1.html)
> 
> o dục đại học hết hiệu lực thi hành từ ngày Thông tư này có hiệu lực.
> 
> 3. Chánh Văn phòng, Cục trưởng Cục Khoa học, Công nghệ và Thông tin, Thủ trưởng các đơn vị thuộc Bộ Giáo dục và Đào tạo, Giám đốc các đại học, học viện, Hiệu trưởng các trường đại học, Hiệu trưởng các trường cao đẳng, Giám đốc các sở Giáo dục và Đào tạo và các tổ chức, cá nhân có liên quan chịu trách nhiệm thi hành Thông tư này./.
> [tt49-2026-ung-dung-cong-nghe-ai:fixed_size:017](https://luatvietnam.vn/giao-duc/thong-tu-49-2026-tt-bgddt-ung-dung-cong-nghe-trong-giao-duc-dai-hoc-va-nghe-nghiep-439350-d1.html)
> 
> # Thông tư 49/2026/TT-BGDĐT — Ứng dụng công nghệ và AI trong giáo dục đại học
> 
> Số: 49/2026/TT-BGDĐT — Hà Nội, ngày 30 tháng 06 năm 2026.
...
1. `tt49-2026-ung-dung-cong-nghe-ai:fixed_size:002` — score 0.3002; relevant=False
...
> 
> 5. Bảo đảm an toàn thông tin, an ninh dữ liệu, an ninh mạng, bảo vệ dữ liệu

2. `una-genai-policy-students:fixed_size:002` — score 0.2635; relevant=False
...
> 
> Bypassing Learning Objectives: Using AI to complete an assignment without engaging with the learning objectives (e.g., 

3. `tt49-2026-ung-dung-cong-nghe-ai:fixed_size:001` — score 0.2266; relevant=False
...
> 
> 2. Ứng dụng công nghệ phải lấy người học làm trung tâm; p
...
> 
> 5. Bảo đảm an toàn thông tin, an ninh dữ liệu, an ninh mạng, bảo vệ dữ liệu
> [tt49-2026-ung-dung-cong-nghe-ai:fixed_size:002](https://luatvietnam.vn/giao-duc/thong-tu-49-2026-tt-bgddt-ung-dung-cong-nghe-trong-giao-duc-dai-hoc-va-nghe-nghiep-439350-d1.html)
> 
> ass discussions.
> 
> Proofreading and Editing: Students may use AI for basic proofreading, formatting, and language refinement, as long as the content remains their own creation.
...
> 
> Bypassing Learning Objectives: Using AI to complete an assignment without engaging with the learning objectives (e.g.,
> [una-genai-policy-students:fixed_size:002](https://www.una.edu/academics/generative-ai-policy.html)
> 
> này áp dụng với:
> 
> 1. Cơ sở giáo dục đại học; cơ sở giáo dục khác tại Khoản 2, Điều 2, Luật Giáo dục đại học 2025; trường cao đẳng; trường trung cấp (sau đây gọi là cơ sở giáo dục).
...
> 
> 2. Ứng dụng công nghệ phải lấy người học làm trung tâm; p
> [tt49-2026-ung-dung-cong-nghe-ai:fixed_size:001](https://luatvietnam.vn/giao-duc/thong-tu-49-2026-tt-bgddt-ung-dung-cong-nghe-trong-giao-duc-dai-hoc-va-nghe-nghiep-439350-d1.html)
...
1. `rmit-vn-academic-integrity-ai:fixed_size:006` — score 0.2725; relevant=False
...
2. `una-genai-policy-students:fixed_size:004` — score 0.1807; relevant=False

> ation in appropriate course format (e.g., APA 7, MLA, ect.) o “This assignment used suggestions from ChatGPT for structuring arguments.”
> 
...
> 
> This course is designed to foster your independent critical thinking, creativity, and skill development. To ensure that you meet the learning objectives and demonstrate your personal understanding of the course material,

3. `rmit-vn-academic-integrity-ai:fixed_size:002` — score 0.1383; relevant=False

> letes an assignment for you without payment, like having someone else write your essay.
> 
...
> 
> These services offer to com
> [rmit-vn-academic-integrity-ai:fixed_size:002](https://www.rmit.edu.vn/students/my-studies/assessment-and-results/academic-integrity)
...
1. `rmit-ai-acknowledgement-guide:fixed_size:003` — score 0.2930; relevant=False

> ou may need to modify this for your referencing style):
> 
...
2. `tt49-2026-ung-dung-cong-nghe-ai:fixed_size:011` — score 0.2478; relevant=False

> p, kiểm tra, đánh giá hoặc nghiên cứu;
> 
> đ) Không công bố hoặc công bố không đầy đủ việc sử dụng công nghệ, trí tuệ nhân tạo khi có yêu cầu theo quy định nội bộ của cơ sở giáo dục và pháp luật của Nhà nước;
> 
> e) Các hành vi khác vi phạm quy định về liêm chính học thuật theo quy định của pháp luật và quy chế của cơ sở giáo dục.
...
> 
> b) Người học, giảng viên và các bên liên quan tuân thủ quy định về liêm chính học thuật; trung thự

3. `una-genai-policy-faculty:fixed_size:003` — score 0.2376; relevant=False

> . Faculty should review the appropriate procedures for documenting AIgenerated content with students. The reference list below includes links to the Modern Language Association, the American Psychological Association, and the Chicago Manual of Style guidelines for documenting AI-generated content.
> 
> Sample Syllabus Policy Statements from The University of Texas at Austin, Center for Teaching and Learning
> 
> ## Data Privacy and Security
> 
> Users must follow data privacy and security guidelines when using generative AI to protect personal and institutional data. This includes adhering to UNA’s data privacy, confidential information policies, and applicable laws and regulations. Entering information into most non-enterprise generative AI tools or services is like posting that data on a public webs
...
> 
> b) Người học, giảng viên và các bên liên quan tuân thủ quy định về liêm chính học thuật; trung thự
> [tt49-2026-ung-dung-cong-nghe-ai:fixed_size:011](https://luatvietnam.vn/giao-duc/thong-tu-49-2026-tt-bgddt-ung-dung-cong-nghe-trong-giao-duc-dai-hoc-va-nghe-nghiep-439350-d1.html)
> 
> . Faculty should review the appropriate procedures for documenting AIgenerated content with students. The reference list below includes links to the Modern Language Association, the American Psychological Association, and the Chicago Manual of Style guidelines for documenting AI-generated content.
> 
> Sample Syllabus Policy Statements from The University of Texas at Austin, Center for Teaching and Learning
...
> 
> Users must follow data privacy and security guidelines when using generative AI to protect personal and institutional data. This includes adhering to UNA’s data privacy, confidential information policies, and applicable laws and regulations. Entering information into most non-enterprise generative AI tools or services is like posting that data on a public webs
> [una-genai-policy-faculty:fixed_size:003](https://www.una.edu/academics/generative-ai-policy.html)
...
1. `una-genai-policy-staff:fixed_size:000` — score 0.2828; relevant=False
...
2. `una-genai-policy-students:fixed_size:004` — score 0.2051; relevant=False
...
3. `rmit-ai-acknowledgement-guide:fixed_size:003` — score 0.1895; relevant=False
...
1. `tt49-2026-ung-dung-cong-nghe-ai:fixed_size:003` — score 0.2507; relevant=False
...
> 
> đ) Các phương thức đà

2. `ueh-dao-van-ai-quy-dinh-chung:fixed_size:005` — score 0.2241; relevant=False
...
3. `ueh-dao-van-ai-quy-dinh-chung:fixed_size:007` — score 0.2059; relevant=False

>  tra chính tả, ngữ pháp, dịch thuật hoặc đề xuất cấu trúc câu, bao gồm nhưng không giới hạn ở Google Translate, Grammarly, chức năng kiểm lỗi ngữ pháp của phần mềm soạn thảo văn bản (như MS Word) và (2) AI tạo sinh (Generative AI), là các hệ thống có khả năng tự tạo nội dung mới như văn bản, mã lệnh, hình ảnh, luận điểm hoặc cấu trúc học thuật theo yêu cầu người dùng, ví dụ: ChatGPT, Claude, Gemini, Copilot và các mô hình ngôn ngữ lớn (LLMs) khác.
> 
> 2. Viên chức, người lao động, người học, giảng viên thỉnh giảng và các cá nhân, tổ chức khác có tham gia hoạt động học thuật tại UEH được sử dụng AI để hỗ trợ hoạt động nghiên cứu và học tập tại UEH trên cơ sở tuân thủ các nguyên tắc sau:
> 
> - Minh bạch: ghi rõ công cụ AI tạo sinh đã sử dụng, mục đích sử dụng (tóm tắt, dịch thuật, tạo hình, viết m
...
> 
> - Minh bạch: ghi rõ công cụ AI tạo sinh đã sử dụng, mục đích sử dụng (tóm tắt, dịch thuật, tạo hình, viết m
> [ueh-dao-van-ai-quy-dinh-chung:fixed_size:007](https://daotao.ueh.edu.vn/quy-dinh-ve-viec-kiem-soat-xu-ly-hanh-vi-dao-van-su-dung-tri-tue-nhan-tao-ai-trong-cac-san-pham-hoc-thuat-tai-dai-hoc-kinh-te-thanh-pho-ho-chi-minh/)
